...
const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    name: 'Santo Antônio',
    category: 'Santos',
    image: '/images/santo-antonio-edited.jpg',
    ...
    colors: [
      { name: 'Branco', value: 'white', image: '/images/santo-antonio-edited.jpg' },
      { name: 'Marrom', value: 'brown', image: '/images/santo-antonio-edited.jpg' },
