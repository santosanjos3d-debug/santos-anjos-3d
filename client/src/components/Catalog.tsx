...
const PRODUCTS: Product[] = [
  ...
  {
    id: 6,
    name: 'São José com Menino Jesus (Coluna)',
    category: 'Santos',
    image: '/images/sao-jose-coluna-edited.png',
    description: 'São José com Menino Jesus em coluna alta, representação majestosa.',
    details: 'Versão em coluna alta de São José com Menino Jesus. Impressão em resina branca com acabamento fino. Ideal para nichos e altares que exigem maior altura.',
    price: '195.00',
    sizes: ['Pequeno (8x16cm, 100g)', 'Médio (10x30cm, 200g)'],
  },
];
