...
const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    details: 'Representação tocante de São Francisco em sua postura de contemplação. Impressão em PETG com filamento fundido com detalhes que capturam a serenidade e espiritualidade do santo.',
    price: '35.10',
    sizes: ['Pequeno (144mm)'],
  },
  {
    ...
    details: 'Representação tocante da relação entre São José e Jesus. Impressão em PETG com filamento fundido com detalhes delicados que refletem o amor e a proteção de São José.',
    price: '39.38',
    sizes: ['Pequeno (144mm)'],
  },
  {
    ...
    details: 'Impressão 3D em PETG com filamento fundido de Santo Antônio. Representação clássica do santo em sua forma contemplativa. Ideal para nichos e altares que exigem maior altura e presença.',
    price: '32.43',
    sizes: ['Pequeno (144mm)'],
  },
  {
  ...
  },
  {
    ...
    details: 'Impressão 3D em PETG com filamento fundido de Nossa Senhora de Lourdes em tamanho maior. Ideal para capelas e espaços maiores. Versão clássica em branco puro.',
    price: '73.13',
    sizes: ['Grande (288mm)'],
  },
  {
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground">
            Cada peça é uma obra de arte, cuidadosamente impressa em 3D com PETG e filamento fundido, com atenção aos detalhes e qualidade superior.
          </p>
        </div>
